...
import { DadosCadastro, IncentivoModel } from '../models/usuario/IncentivoModel';
...
export class LoginService {
  ...
  loginIntegracaoEMS_Expenses(nome: string) {
    return this.httpClient.get<UsuarioModel>(`${this.baseUrl}/${this.usuario}/LoginIntegracao/${nome}`)
  }



  InsereIncentivo(incentivoModel: IncentivoModel) {
    return this.httpClient.post<any>(`${this.baseUrl}/${this.usuario}/InsereIncentivo`, incentivoModel)
  }



  ObterUsuario(celular: string) {

    var dados = { Celular: celular };
    return this.httpClient.post<DadosCadastro>(`${this.baseUrl}/${this.usuario}/ObterUsuario`, dados)
  }
}