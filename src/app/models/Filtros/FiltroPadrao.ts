...
export class FiltroPadrao {
    ...
    constructor() {
        ...
        this.TipoColeta = new Array<PadraoComboFiltro>();
        this.Status = new Array<PadraoComboFiltro>();
    }
    ...
    // new parameters
    TipoColeta: Array<PadraoComboFiltro>;
    Status: Array<PadraoComboFiltro>;
    ModelSL : Array<PadraoComboFiltro>;
